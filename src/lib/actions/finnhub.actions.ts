      ...
      results = profiles
        .map(({ sym, profile }) => {
          ...
          const name: string | undefined =
            (profile as { name?: string; ticker?: string })?.name ||
            (profile as { name?: string; ticker?: string })?.ticker ||
            undefined;
          const exchange: string | undefined = (profile as { exchange?: string })?.exchange || undefined;
